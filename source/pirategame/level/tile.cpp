...
{
	if ((m_pos.x + _camPos.x) > -(TILE_WIDTH * 3.0f) && (m_pos.y - _camPos.y) > -(TILE_HEIGHT * 3.0f) &&
		(m_pos.x + _camPos.x) < (m_screenW + TILE_WIDTH * 3.0f) && (m_pos.y - _camPos.y) < (m_screenH + TILE_HEIGHT * 3.0f))
	{
